...
public class UserActivity extends AppCompatActivity {
  ...
  public void addUser(UserBean u){
    Call<UserBean> call = userService.addUser(u);
  ...
  public void updateUser(int id, UserBean u){
    Call<UserBean> call = userService.updateUser(id, u);
    call.enqueue(new Callback<UserBean>() {
      @Override
      public void onResponse(Call<UserBean> call, Response<UserBean> response) {
        if(response.isSuccessful()){
  ...
  public void deleteUser(int id){
    Call<UserBean> call = userService.deleteUser(id);
    call.enqueue(new Callback<UserBean>() {
      @Override
      public void onResponse(Call<UserBean> call, Response<UserBean> response) {
        if(response.isSuccessful()){
